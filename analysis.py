...
file = glob.glob("time_data.csv/*.csv")
filename = file[0]
...
file = glob.glob("state_data.csv/*.csv")
filename = file[0]
...
file = glob.glob("submission_score.csv/*.csv")
filename = file[0]
...
file = glob.glob("comment_score.csv/*.csv")
filename = file[0]
story = pd.read_csv(filename)
plt.figure(figsize=(12,5))
fig = plt.figure()
